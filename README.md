...
3) Запускаем jar архив: `java -jar target/bank-rest-0.1.0.jar`
...
- Реализована **HTTP Basic аутентификация** на основе имени пользователя и пароля. Пароли хранятся в виде **bcrypt-хэшей**.
- Поддерживается ролевая модель: **ADMIN** и **USER**, доступ к эндпоинтам ограничен ролями.
- Класс `SecurityUser` адаптирует доменную сущность User к интерфейсу `UserDetails`.
...
- В планах: переход на JWT-аутентификацию.
